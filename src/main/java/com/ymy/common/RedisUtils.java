...
public class RedisUtils {
    ...
    public Object evalsha(String script, List<String> keys, List<String> args) {
        ...
        try {
            jedis = getJedis();
            res = jedis.evalsha(script, keys, args);
        } catch (Exception e) {
            LOGGER.error(e.getMessage());
        } finally {
            closeJedis(jedis);
    ...
    public ScanResult scan(String cursor, ScanParams scanParams) {
        Jedis jedis = null;
        ScanResult res = null;
        try {
            jedis = getJedis();
            res = jedis.scan(cursor, scanParams);
        } catch (Exception e) {
    ...
    public Set<Tuple> zrevrangeByScoreWithScore(String key, String max, String min) {
        Jedis jedis = null;
        Set<Tuple> res = null;
        try {
            jedis = getJedis();
    ...
    public Set<Tuple> zrangeByScoreWithScore(String key, String max, String min) {
        Jedis jedis = null;
        Set<Tuple> res = null;
        try {
            jedis = getJedis();
